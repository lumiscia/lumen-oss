...
pub enum FrameBinding {
    ...
    Shape {
        ...
        fill_paint: crate::node::NodeProperty,
        fill_gradient_start: crate::node::NodeProperty,
        fill_gradient_end: crate::node::NodeProperty,
        fill_gradient_start_color: crate::node::NodeProperty,
        fill_gradient_end_color: crate::node::NodeProperty,
