...
export function renderMetaTypes(manifest: MetaManifest): string {
  ...
  return `// Generated by tooling/generate-types from vendor/lumen-definitions/meta.json.
// Do not edit by hand.
...
export function renderCompositionTypes(): string {
  return `// Generated by tooling/generate-types from vendor/lumen-definitions/schemas/composition.schema.json.
// Do not edit by hand.
